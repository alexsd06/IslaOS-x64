...
void fetch(char str[])
{
    ...
    uint64_t *image_pixels=(uint64_t*)((uint64_t)image_normal+sizeof(tga_header_t));
    kprintln("");
    ...
    kprint ("                               Header adress: "); kprintint((uint64_t)image_normal); kprintln("");
    kprint ("                               Data adress: "); kprintint((uint64_t)image_pixels); kprintln("");
